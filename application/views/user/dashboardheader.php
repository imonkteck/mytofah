...
<script src="<?php echo base_url()?>js/fastselect.standalone.js"></script>
...
<script type = "text/javascript" language = "javascript">
	     $(document).ready(function() {
            ...
            $("#bar-first").click(function(){
               $(".bar-container-first").effect( "fade", {times:1,direction:'left'}, 300 );
			   $(".bar-container-second").hide()
			    $(".bar-container-third").hide()
            });
			 $("#bar-second").click(function(){
               $(".bar-container-second").effect( "fade", {times:1,direction:'left'}, 300 );
			   $(".bar-container-first").hide()
			    $(".bar-container-third").hide()
            });
			$("#bar-third").click(function(){
               $(".bar-container-third").effect( "fade", {times:1,direction:'left'}, 300 );
			   $(".bar-container-first").hide()
			    $(".bar-container-second").hide()
            });
         });
